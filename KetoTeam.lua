...
Insights
Settings
KetoTeam/KetoTeam.lua
@KetoTeam
KetoTeam Update KetoTeam.lua
Latest commit 80c8687 10 minutes ago
 History
 1 contributor
11441 lines (11329 sloc)  552 KB
...
SUDO = SUDO
sudo_users = {SUDO,325310838,1026415375}   
print([[
Source Keto
]])
...
local KetoTeam_Msg = ''  
if msgs < 100 then 
KetoTeam_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KetoTeam_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KetoTeam_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KetoTeam_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KetoTeam_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KetoTeam_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KetoTeam_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KetoTeam_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KetoTeam_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KetoTeam_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KetoTeam_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KetoTeam_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KetoTeam_Msg = 'رب التفاعل'  
end 
return KetoTeam_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@uuuuu1")  
...
--------------------------------------------------------------------------------------------------------------
function SourceKetoTeam(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if start then 
SourceKetoTeamr = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'كطيو')
SourceKetoTeamr = '*⌯︙اهلا عزيزي*\n*⌯︙انا بوت اسمي '..Namot..'*\n*⌯︙اختصاصي حمايه الكروبات*\n*⌯︙من تكرار والسبام والتوجيه والخ…*\n*⌯︙لتفعيلي اتبع الاخطوات…↓*\n*⌯︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⌯︙[قناة سورس البوت](http://t.me/KetoTaem)'
end
send(msg.chat_id_, msg.id_, SourceKetoTeamr) 
end
end
...
send(msg.chat_id_, msg.id_,KetoTeam_Msg) 
return false  
end 
if text then
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..KetoTeamk..''..KetoTeam..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
local KetoTeam1_Msg = database:get(bot_id.."KetoTeam1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KetoTeam1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KetoTaem')..') \n ⌯︙'..KetoTeam1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KetoTeam_Msg and not Special(msg) then  
local KetoTeam_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KetoTeam_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..KetoTeam_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/KetoTaem)}\n⌯︙["..KetoTeam_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا »* {["..data.first_name_.."](T.ME/KetoTaem)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
database:sadd(bot_id.."KetoTeam:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KetoTeam:blocname"..msg.chat_id_)
...
function uuuuu1_name(t1,t2)
if t2.id_ then 
name_KetoTeam = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_KetoTeam then 
names_KetoTeam = database:smembers(bot_id.."KetoTeam:blocname"..msg.chat_id_) or ""
if names_KetoTeam and names_KetoTeam[1] then 
for i=1,#names_KetoTeam do 
if name_KetoTeam:match("(.*)("..names_KetoTeam[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, uuuuu1_name)
end
...
database:set(bot_id.."KetoTeam:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KetoTeam:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KetoTeam:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KetoTeam:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KetoTeam:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_KetoTeama_new(KetoTeam1,KetoTeam2)
if KetoTeam2 and KetoTeam2.first_name_ then 
if KetoTeam2.first_name_:match("(.*)"..database:get(bot_id.."KetoTeam:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KetoTeam:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KetoTeam_nnn = database:get(bot_id.."KetoTeam:nump"..msg.chat_id_) or 5
local KetoTeam_nnn2 = database:get(bot_id.."KetoTeam:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KetoTeam_nnn2) == tonumber(KetoTeam_nnn) or tonumber(KetoTeam_nnn2) > tonumber(KetoTeam_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KetoTeam:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..KetoTeam2.username_.."](https://t.me/"..(KetoTeam2.username_ or "KetoTaem")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KetoTeam:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(KetoTeam_nnn) - tonumber(KetoTeam_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KetoTeama_new)
end
end
...
local KetoTeamChengName = database:get(bot_id.."KetoTeam:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KetoTeamChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KetoTeamChengName..']')
database:del(bot_id.."KetoTeam:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KetoTeamChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KetoTeam:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KetoTeamChengUserName = database:get(bot_id.."KetoTeam:Cheng:UserName"..data.id_)
if not data.username_ then 
if KetoTeamChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KetoTeamChengUserName..']')
database:del(bot_id.."KetoTeam:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KetoTeamChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KetoTeam:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KetoTeamChengPhoto = database:get(bot_id.."KetoTeam:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KetoTeamChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KetoTeam:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KetoTeamChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KetoTeam:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
*أهلاً بك في السوࢪس* [KeTo TeAm](t.me/KetoTaem)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس',url="https://t.me/KetoTaem"},
},
{
{text = 'مطوࢪ السوࢪس',url="t.me/uuuuu1"},
},
{
{text = 'تواصل السوࢪس',url="t.me/uuuuu1"},
},
}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KetoTaem')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KetoTaem')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
function start_function(extra, result, success)
if KetoTeamSudoBot(result.sender_user_id_) then
...
if KetoTeamSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if KetoTeamSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if KetoTeamSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if database:get(bot_id.."uuuuu1:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'uuuuu1:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local json_file, res = https.request("https://raw.githubusercontent.com/KetoTeam/Files_KetoTeam/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('KetoTeam.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس كطيو* \n") 
end
return false
end
...
function Function_KetoTeam(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KetoTeam, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KetoTeam, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KetoTaem')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'KetoTaem')..')'
...
database:set(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KetoTeam1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KetoTeam1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KetoTeam1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KetoTeam1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KetoTeam1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KetoTeam1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KetoTeam1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KetoTeam1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KetoTeam1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KetoTeam1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KetoTeam1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌯︙قائمة المنع* \n*•━━━━━━ KeTo ━━━━━━━•*\n"
for k,v in pairs(list) do  
local KetoTeam_Msg = database:get(bot_id.."KetoTeam1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KetoTeam_Msg.."}\n"
end  
if #list == 0 then  
...
if not database:get(bot_id..'uuuuu1:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'uuuuu1:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كطيو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كطيو')
local KetoTeam_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..KetoTeam_Msg[math.random(#KetoTeam_Msg)]..']') 
return false
end
...
},function(ta,KetoTeam)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ KeTo ━━━━━━━•*\n"
x = 0
local list = KetoTeam.members_
for k, v in pairs(list) do
x = x + 1
...
if KetoTeamSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كطيو').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KetoTaem')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KetoTeamdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ KeTo ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[KeTo TeAm](t.me/KetoTaem) ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كطيو')
...
KetoTeam = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KetoTeam)
...
--------------------------------------------------------------------------------------------------------------
SourceKetoTeam(data.message_,data)
...
------------------------------------------------------------------------
local KetoTeamAbot = database:get(bot_id.."KetoTeam1:Add:Filter:Rp2"..text..result.chat_id_)   
if KetoTeamAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..KetoTeamAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local KetoTeam1_Msg = database:get(bot_id.."KetoTeam1:Add:Filter:Rp2"..text..result.chat_id_)   
if KetoTeam1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..KetoTeam1_Msg)
