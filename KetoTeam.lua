...
if DevKetoTeam(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KetoTeam/Files_Keto/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KetoTeam/Files_Keto/main/File_Bot/"..file)
if res == 200 then
